...
function NotificationBanner({
  ...
  return (
    <>
      {resultOfUserAction !== "" && (
        <div className="status-update align-center my-4 mx-auto flex w-11/12 items-center justify-between gap-5 border-l-4 border-l-green-600 bg-white p-2 md:pl-12">
          <p>
